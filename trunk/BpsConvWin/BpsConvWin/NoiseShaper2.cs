...
namespace BpsConvWin {
    class NoiseShaper2 {
        ...
        /// </summary>
        /// <param name="sampleFrom">input sample value. 16bit signed (-32768 to +32767)</param>
        /// <param name="quantizedBit">target quantized bit. 1 to 15</param>
        /// <returns>noise shaping filter output sample. 16bit signed</returns>
        public short Filter16(short sampleFrom, int quantizedBit) {
            ushort mask = (ushort)(0xffffU << (16 - quantizedBit));
            ...
            short sampleY = (short)(((short)v) & mask);

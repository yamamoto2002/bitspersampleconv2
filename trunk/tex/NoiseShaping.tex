...
\begin{eqnarray*}
|H_1(\mathrm{e}^{j\omega})| &=& \sqrt{ 2 -2\cos(\omega) } \\
                 &=& \sqrt{ 2(1 -\cos(\omega)) } \\
                 &=& \sqrt{ 4\sin^2(\frac{\omega}{2})) } \\
                 &=& 2|\sin(\frac{\omega}{2})|
\end{eqnarray*}
\begin{eqnarray}
...
|H_2(\mathrm{e}^{j\omega})| &=& \sqrt{ \left\{ 1-2\cos(\omega)+2\cos^2(\omega)-1 \right\}^2 + \left\{ 2\sin(\omega) - 2\sin(\omega)\cos(\omega) \right\}^2 } \\
                            ...
                            &=& \sqrt{ (1-\cos(\omega))^2(4\cos^2(\omega) + 4\sin^2(\omega)) } \\
                            &=& \sqrt{ 4(1-\cos(\omega))^2 } \\
                            &=& 2|1-\cos(\omega)|
\end{eqnarray*}
\begin{eqnarray}

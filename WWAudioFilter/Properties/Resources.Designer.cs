...
namespace WWAudioFilter.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   pick 1st sample from incoming two samples に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   pick 2nd sample from incoming two samples に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   Downsample: {0}x, pick {1} th sample に類似しているローカライズされた文字列を検索します。
        /// </summary>
        ...
        /// <summary>
        ///   Downsampler に類似しているローカライズされた文字列を検索します。
        /// </summary>
